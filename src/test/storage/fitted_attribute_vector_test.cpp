...
TEST_F(StorageFittedAttributeVectorTest, Width) { EXPECT_EQ(fav.width(), 1u); }
...
TEST_F(StorageFittedAttributeVectorTest, SetOutOfRange) { EXPECT_THROW(fav.set(5, ValueID(2)), std::exception); }
